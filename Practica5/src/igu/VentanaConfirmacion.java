...
public class VentanaConfirmacion extends JDialog {
	 ...
	 * Graba el pedido y reinicia la ejecucion de la TPV
		...
		if (btFinalizar == null) {
			...
			btFinalizar.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					pedido.grabarPedido(codigo, tipoPedido);
	...
	/**
	 * Establece el tipo de pedido escogido por el cliente
	 * @param tipo, String
	 */
	protected void setTipoPedido(String tipo) {
