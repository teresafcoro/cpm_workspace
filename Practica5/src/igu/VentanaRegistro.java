...
public class VentanaRegistro extends JDialog {
	...
	private JLabel getLbPassword1() {
		if (lbPassword1 == null) {
			...
			lbPassword1.setBounds(10, 133, 153, 25);
			lbPassword1.setFont(new Font("Tahoma", Font.PLAIN, 12));
		}
		return lbPassword1;
	}
	...
	private JPasswordField getPasswordField1() {
		if (passwordField1 == null) {
			...
			passwordField1.setBounds(183, 133, 217, 25);
			passwordField1.setFont(new Font("Tahoma", Font.PLAIN, 12));
		}
	...
	private void mostrarVentanaConfirmacion() {
		...
		if (getRdLocal().isSelected())
			vc.setTipoPedido("Local");
		else
			vc.setTipoPedido("Llevar");
		vc.setVisible(true);
	}
